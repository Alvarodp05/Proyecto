...
// 3. DEFINIMOS QUÉ MÁQUINA SOMOS (¡POR ID!)
$machine_id = 'maquina_1_1';
...
<head>
    ...
    <title>JEFE - <?php echo htmlspecialchars($config->machine_name); ?></title>
    ...
    <div class="main-container">
        ...
        <div class="content-section">
            <div class="content-header">
                ...
                <div class="header-logo"><img src="../../Lib/Imagenes/logo_esquina.jpg" alt="Logo A6T"></div>
            </div> 
            ...
            <form action="../../Capa_negocio/Maquinas/guardar_bd.php" method="POST">
                ...
                <input type="hidden" name="redirect_url" value="../../Capa_usuario/Maquinas/maquina_jefe_1_1.php">
