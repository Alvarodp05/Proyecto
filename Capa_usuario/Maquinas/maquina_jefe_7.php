...
// 3. DEFINIMOS QUÉ MÁQUINA SOMOS (¡POR ID, NO POR ARCHIVO!)
$machine_id = 'maquina_7';
    ...
    <div class="main-container">
        ...
        <div class="content-section">
            ...
            <form action="../../Capa_negocio/Maquinas/guardar_bd.php" method="POST">
                ...
                <input type="hidden" name="redirect_url" value="../../Capa_usuario/Maquinas/maquina_jefe_7.php">
