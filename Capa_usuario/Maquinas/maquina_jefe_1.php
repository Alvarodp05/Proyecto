...
// Ahora pasamos el ID de la máquina en la Base de Datos, NO la ruta del archivo.
    ...
    <div class="main-container">
        ...
        <div class="content-section">
            ...
            <form action="../../Capa_negocio/Maquinas/guardar_bd.php" method="POST">
                ...
                <input type="hidden" name="redirect_url" value="../../Capa_usuario/Maquinas/maquina_jefe_1.php">
